...
@interface ZXEditorCell ()

@property(nonatomic,strong)UIImageView *IV;
@property(nonatomic,strong)UIImageView *UIV;
@end

@implementation ZXEditorCell
...
- (UILabel *)introLb{
    if (!_introLb) {
        ...
        [favBtn setBackgroundImage:[UIImage imageNamed:@"find_album_unfav_n"] forState:UIControlStateNormal];
        [favBtn setBackgroundImage:[UIImage imageNamed:@"find_album_fav_n"] forState:UIControlStateSelected];
        ...
        [favBtn bk_addEventHandler:^(UIButton *sender) {
        ...
        [_introLb mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.bottom.mas_equalTo(favBtn.mas_left).mas_equalTo(-10);
        }];
