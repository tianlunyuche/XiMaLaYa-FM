...
@interface ZXSpecialMoreViewMoel ()

@property (nonatomic,strong) ZXSpecialModel *model;
// 具体天个数
...
@implementation ZXSpecialMoreViewMoel

#pragma mark - 获取数据方法
- (void)getDataCompletionHandle:(void (^)(NSError *))completed {
    self.dataTask = [ZXMoreCotentNetManager getSpecialForPage:_page completionHandle:^(ZXSpecialModel* responseObject, NSError *error) {
        // 记录模型数组
