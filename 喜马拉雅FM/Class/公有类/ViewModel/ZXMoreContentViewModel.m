...
@interface ZXMoreContentViewModel ()
@property (nonatomic,strong)ZXContentsModel *model;
@end

@implementation ZXMoreContentViewModel
...
- (void)getDataCompletionHandle:(void (^)(NSError *))completed {
    self.dataTask = [ZXMoreCotentNetManager getContentsForForCategoryId:_categoryId contentType:_type completionHandle:^(ZXContentsModel* responseObject, NSError *error) {
