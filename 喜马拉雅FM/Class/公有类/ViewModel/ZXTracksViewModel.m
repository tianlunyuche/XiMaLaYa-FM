...
@interface ZXTracksViewModel ()
@property (nonatomic,strong) ZXDestinationModel *model;
@end

@implementation ZXTracksViewModel
...
- (void)getDataCompletionHandle:(void (^)(NSError *))completed {
    self.dataTask = [ZXMoreCotentNetManager getTracksForAlbumId:_albumId mainTitle:_title idAsc:_asc completionHandle:^(ZXDestinationModel* responseObject, NSError *error) {
