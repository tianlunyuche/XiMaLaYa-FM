...
#import "ZXMoreRecommendController.h"
...
@interface ZXMoreRecommendController ()<UITableViewDataSource,UITableViewDelegate,iCarouselDataSource,iCarouselDelegate>
...
@implementation ZXMoreRecommendController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        ...
        ZXMoreCategoryCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MCell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    return !section ? nil : [[ZXTitleView alloc] initWithTitle:[self.moreVM mainTitleForSection:section] hasMore:[self.moreVM hasMoreForSection:section]];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ZXDestinationVC *vc = [[ZXDestinationVC alloc] initWithAlbumId:[self.moreVM albumIdForIndexPath:indexPath] title:[self.moreVM titleForIndexPath:indexPath]];
    // 隐藏状态栏及底部栏
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[ZXMoreCategoryCell class] forCellReuseIdentifier:@"MCell"];
        ...
        // 封装好的头部滚动视图
        ZXFocusImageScrollView *scrollView = [[ZXFocusImageScrollView alloc] initWithFocusImgNumber:self.moreVM.focusImgNumber];
