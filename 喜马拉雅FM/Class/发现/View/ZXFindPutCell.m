...
#pragma mark - 懒加载并布局
- (ZXContentShowView *)clickBtn0{
    if (!_clickBtn0) {
        _clickBtn0 =[ZXContentShowView new];
...
- (ZXContentShowView *)clickBtn1{
    if (!_clickBtn1) {
        _clickBtn1 =[ZXContentShowView new];
...
- (ZXContentShowView *)clickBtn2{
    if (!_clickBtn2) {
        _clickBtn2 =[ZXContentShowView new];
