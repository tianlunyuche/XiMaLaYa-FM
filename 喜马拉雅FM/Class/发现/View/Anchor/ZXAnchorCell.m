...
@interface ZXAnchorCell ()
// 关注按钮
@property (nonatomic,strong) UIButton *attractBtn;
@end

@implementation ZXAnchorCell
...
- (ZXAnchorView *)anchorView0 {
    if (!_anchorView0) {
        _anchorView0 = [ZXAnchorView new];
...
- (ZXAnchorView *)anchorView1 {
    if (!_anchorView1) {
        _anchorView1 = [ZXAnchorView new];
...
- (ZXAnchorView *)anchorView2 {
    if (!_anchorView2) {
        _anchorView2 = [ZXAnchorView new];
