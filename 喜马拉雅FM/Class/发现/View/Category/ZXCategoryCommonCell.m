...
@implementation ZXCategoryCommonCell
...
- (ZXCategoryButton *)btn1 {
    if (!_btn1) {
        _btn1 = [ZXCategoryButton new];
...
- (ZXCategoryButton *)btn2 {
    if (!_btn2) {
        _btn2 = [ZXCategoryButton new];
