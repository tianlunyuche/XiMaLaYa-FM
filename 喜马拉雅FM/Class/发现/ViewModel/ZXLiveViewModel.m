...
@interface ZXLiveViewModel ()

@property (nonatomic,strong)ZXLiveModel *model;

@end

@implementation ZXLiveViewModel
//网络加载数据
- (void)getDataCompletionHandle:(void (^)(NSError *))completed{
    self.dataTask =[ZXHomePageNetManager getLivePageCompletionHandle:^(ZXLiveModel * responseObject, NSError *error) {
